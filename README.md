...
Care Plan Builder was inspired by lived caregiving experience. The **Show the example plan** button presents a fictionalized composite household: its roles, schedules, meals and care-related tasks have been deliberately altered and do not describe any person or household. It demonstrates a daily care rhythm, household work, meal and shopping planning, a blank measurement-table design, coverage arrangements, budget management and coordination with support services.
...
Bakım Planı Oluşturucu, gerçek bir bakım verme deneyiminden ilham aldı. **Örnek planı göster** düğmesi kurgulanmış bileşik bir haneyi sunar: roller, programlar, yemekler ve bakımla ilgili görevler özellikle değiştirilmiştir ve herhangi bir kişiyi veya haneyi anlatmaz. Günlük bakım düzenini, ev işlerini, yemek ve alışveriş planlamasını, boş bir ölçüm tablosu tasarımını, devralma düzenini, bütçe yönetimini ve destek hizmetleriyle koordinasyonu gösterir.
